function signal = import_usb_serial(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   SIGNAL = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   SIGNAL = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   signal = importfile('trial11.txt',2, 300010);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/04 17:30:46
